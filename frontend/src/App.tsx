    ...
    <HelmetProvider>
      <Router>
        <div className="min-h-screen bg-white">
          ...
          {/* This id is REQUIRED for the skip-link in Header */}
          <main id="main-content">
            <Routes>
              ...
              <Route
                path="/leesburg-window-cleaning"
                element={<LeesburgHome />}
              />
              <Route
                path="/ashburn-window-cleaning"
                element={<AshburnHome />}
              />
              <Route
                path="/sterling-window-cleaning"
                element={<SterlingHome />}
              />
              <Route
                path="/herndon-window-cleaning"
                element={<HerndonHome />}
              />
              ...
              <Route
                ...
                element={
                  <ProtectedRoute
                    allowedRoles={[ROLES.USER, ROLES.EMPLOYEE, ROLES.ADMIN]}
                  >
                    <Quoting />
                  </ProtectedRoute>
                }
